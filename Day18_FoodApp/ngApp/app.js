...
(function (MyApp) {
    angular.module('MyApp', ['ngRoute', 'ngResource', 'ui.bootstrap']).config(function ($routeProvider, $locationProvider) {
        $routeProvider
            .when('/', {
            templateUrl: '/ngApp/views/foods.html',
            controller: MyApp.Controllers.FoodsController,
            controllerAs: 'controller'
        })
            .when('/createFood', {
            templateUrl: '/ngApp/views/createFood.html',
            controller: MyApp.Controllers.CreateFoodController,
            controllerAs: 'controller'
        })
            .when('/about', {
